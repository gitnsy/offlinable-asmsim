...
, new HeavySub("試験型MLRS", "mlrs", 520,1)
, new HeavySub("高速型MLRS", "mlrs", 550, 2)
, new HeavySub("強化型MLRS", "mlrs", 600, 3)
, new HeavySub("多連装型MLRS", "mlrs", 620, 4)
, new HeavySub("斉射型MLRS", "mlrs", 630, 5)
...
, new HeavySub("スプレッドランチャー", "spl", 550,1)
, new HeavySub("SPL-サージ", "spl", 580, 2)
, new HeavySub("SPL-プロミネンス", "spl", 590, 3)];
})(asmsim.data);