...
, new Arm("E.D.G.‐θ", "D", "D", "A-", "C", "EDG", 860, 0.9)
...
, new Arm("ディスカス・エヴォル", "B", "C", "C", "B+", "Discus", 920, 1.5)
...
, new Arm("アスラ", "E", "E", "A-", "B-", "ASURA", 640, 0.7)
, new Arm("アスラ・弐", "E", "E-", "B-", "S", "ASURA", 620, 0.5)
, new Arm("アスラ・参", "E", "D-", "A", "C", "ASURA", 670, 0.7)]
})(asmsim.data);