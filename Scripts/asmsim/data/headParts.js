...
(function (data) {
    ...
    data.heads = [
 new Head("クーガーⅠ型","C+","C","D","C+","Cooger",1,600,2)
,new Head("クーガーⅡ型","C+","C","C","D+","Cooger",2,620,2.2)
,new Head("クーガーS型","C+","B+","D+","B+","Cooger",3,630,1.7)
,new Head("クーガーNX","B-","B","D","B-","Cooger",4,650,1.9)
,new Head("ツェーブラ38","C","B+","C+","D+","Zebra",1,550,2.3)
,new Head("ツェーブラ39","C","B+","B+","E+","Zebra",2,570,2.6)
,new Head("ツェーブラ41","C","A-","C","C+","Zebra",3,580,2.2)
,new Head("ツェーブラ48C","C","B+","A+","D","Zebra",4,600,2.4)
...
,new Head("エンフォーサーX型","C+","B","C-","C+","Enfocer",4,640,2.4)
,new Head("E.D.G.-α","E","A+","B-","D+","EDG",1,550,2.5)
,new Head("E.D.G.-β","E","A+","A+","E","EDG",2,560,2.7)
,new Head("E.D.G.-δ","E","A+","C+","C+","EDG",3,570,2.5)
,new Head("E.D.G.-θ","E+","S","C+","C","EDG",4,560,2.6)
...
,new Head("ディスカス・エヴォル","C","B","C+","B-","Discus",4,610,2.3)
...
,new Head("ロージーR","A+","E","D+","C","Rosie",1,810,2.1)
...
,new Head("ランドバルクAT","A+","C-","C+","D","LANDBULK",4,800,2)
...
,new Head("ヤクシャ・弐","D-","A-","C-","C+","YAKSHA",3,520,2.2)
,new Head("セイバーⅠ型","D-","C-","B+","B+","Saber",1,480,2.8)
,new Head("セイバーⅠ型R","D-","C-","B-","A+","Saber",2,510,2.7)
,new Head("セイバーⅡ型","D-","C","C","A+","Saber",3,530,2.8)
,new Head("セイバーZX","D+","B-","A","C-","Saber",4,540,2.7)
,new Head("B.U.Z.-α","E","A-","C+","D+","BUZ",1,490,2.6)
,new Head("B.U.Z.-β","E","A-","A+","E+","BUZ",2,520,2.8)
,new Head("B.U.Z.-γ","E","A+","D","B","BUZ",3,500,2.3)
,new Head("フォーミュラⅡ型","D-","B","D+","B+","Formula",1,530,2.6)
,new Head("フォーミュラⅡ型C","D-","B+","D","A-","Formula",2,510,2.3)
,new Head("フォーミュラF型","D-","B+","B-","C+","Formula",3,550,2.7)
,new Head("アスラ","E","A+","D","C+","ASURA",1,470,2.3)
,new Head("アスラ・弐","E","A+","E","B+","ASURA",2,460,2.1)
,new Head("アスラ・参","E","S","D-","C","ASURA",3,490,2.4)
,new Head("月影","D-","B","C","C","Getsuei",1,450,2.3)
,new Head("月影・新","D-","B","B-","C-","Getsuei",2,460,2.2)
,new Head("月影・暁","D+","C+","C+","C+","Getsuei",3,520,2.7)];
})(asmsim.data);
