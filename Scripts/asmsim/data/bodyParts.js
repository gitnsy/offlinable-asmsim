...
(function (data) {
    ...
    data.bodys = [new Body("クーガーⅠ型", "C+", "C+", "D+", "C+", "Cooger", 1, 1250, 2)
        ...
        , new Body("ツェーブラ38", "C", "C-", "C", "C+", "Zebra", 1, 1050, 2)
        , new Body("ツェーブラ39", "C", "A-", "D", "C+", "Zebra", 2, 1100, 1.9)
        , new Body("ツェーブラ41", "C+", "E+", "A-", "C+", "Zebra", 3, 1150, 2.1)
        , new Body("ツェーブラ48C", "C", "B", "C-", "C+", "Zebra", 4, 1180, 2.3)
        , new Body("エンフォーサーⅠ型", "C", "B", "D+", "C+", "Enfocer", 1, 1150, 1.8)
        , new Body("エンフォーサーⅡ型", "B", "B-", "D+", "C+", "Enfocer", 2, 1300, 1.9)
        , new Body("エンフォーサーⅢ型", "C", "A+", "E+", "C+", "Enfocer", 3, 1250, 2.6)
        , new Body("エンフォーサーX型", "B-", "B", "D-", "B+", "Enfocer", 4, 1280, 2.5)
        , new Body("E.D.G.-α", "D-", "D", "B", "A+", "EDG", 1, 1250, 2.6)
        , new Body("E.D.G.-β", "D-", "C+", "C", "A+", "EDG", 2, 1280, 2.7)
        , new Body("E.D.G.-δ", "D-", "E", "A+", "A+", "EDG", 3, 1250, 1.4)
        , new Body("E.D.G.-θ", "D+", "B", "C-", "A+", "EDG", 4, 1200, 2.1)
        ...
        , new Body("ランドバルクAT", "A", "C+", "D+", "B+", "LANDBULK", 4, 1460, 2.2)
        , new Body("ヤーデ54", "A-", "C+", "C-", "C+", "JADE", 1, 1380, 1.8)
        , new Body("ヤーデ54S", "A", "B+", "D-", "D", "JADE", 2, 1490, 2.3)
        , new Body("ヤーデ55", "A+", "C+", "D", "C+", "JADE", 3, 1400, 1.7)
        , new Body("ジーシェン", "B+", "C+", "B-", "D", "JIXIEN", 1, 1460, 1.8)
        , new Body("ジーシェン・フー", "A-", "B+", "D+", "D", "JIXIEN", 2, 1480, 2.2)
        , new Body("ジーシェン・シー", "B+", "A-", "C", "C-", "JIXIEN", 3, 1470, 2)
        , new Body("シュライクⅠ型", "E", "C-", "D", "A+", "Shrike", 1, 1000, 3)
        , new Body("シュライクⅡ型", "E", "B", "E", "A+", "Shrike", 2, 1030, 3.1)
        , new Body("シュライクⅤ型", "D-", "C-", "C", "A+", "Shrike", 3, 1070, 2.9)
        , new Body("シュライクW型", "D-", "B", "D-", "S", "Shrike", 4, 1100, 2.8)
        , new Body("ヤクシャ", "D", "B", "D+", "B+", "YAKSHA", 1, 1150, 2.3)
        , new Body("ヤクシャ・改", "D-", "A+", "E+", "B+", "YAKSHA", 2, 1160, 2.7)
        ...
        , new Body("セイバーⅡ型", "D-", "A-", "E+", "A+", "Saber", 3, 1160, 3.1)
        , new Body("セイバーZX", "D+", "S-", "E+", "A+", "Saber", 4, 1200, 2.6)
        , new Body("B.U.Z.-α", "E", "B-", "E+", "A+", "BUZ", 1, 980, 2.8)
        , new Body("B.U.Z.-β", "E", "C-", "C", "A-", "BUZ", 2, 1000, 2.5)
        , new Body("B.U.Z.-γ", "E", "A+", "E", "A+", "BUZ", 3, 1060, 2.9)
        , new Body("フォーミュラⅡ型", "D-", "C-", "C+", "A-", "Formula", 1, 1110, 2.5)
        , new Body("フォーミュラⅡ型C", "D-", "B", "D+", "A-", "Formula", 2, 1130, 2.7)
        , new Body("フォーミュラF型", "D+", "E+", "B+", "A-", "Formula", 3, 1170, 2.6)
