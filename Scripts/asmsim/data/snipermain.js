...
(function (data) {
    function SniperMain(name, bland, weight, rank) {
        this.name = name;
        this.bland = bland;
        this.weight = weight;
        this.rank = rank;
...
, new SniperMain("38式狙撃銃・鳴神", "38", 360, 5)
, new SniperMain("フローズンシューター", "38", 270, 2.1)
, new SniperMain("遠雷/CV", "38", 290, 4.1)
, new SniperMain("イーグルアイV44", "eeye", 220, 1)
, new SniperMain("イーグルアイTF", "eeye", 200, 2)
, new SniperMain("イーグルアイ・ゼロ", "eeye", 260, 3)
, new SniperMain("イーグルアイVX", "eeye", 270, 4)
...
, new SniperMain("55式可変狙撃銃", "sws", 300, 4)
, new SniperMain("炸薬狙撃銃", "burster", 350, 1)
...
, new SniperMain("LZ-ヴェスパイン", "lz", 330, 4)
, new SniperMain("LBR-ムーンレイ", "lbr", 260, 1)
, new SniperMain("LBR-ムーンレイB", "lbr", 280, 2)
, new SniperMain("LBR-ムーンレイR", "lbr", 310, 3)
, new SniperMain("LBR-エクリプス", "lbr", 340, 4)
, new SniperMain("ブレイザーライフル", "brazer", 320, 1)
, new SniperMain("ブレイザーRF", "brazer", 350, 2)
