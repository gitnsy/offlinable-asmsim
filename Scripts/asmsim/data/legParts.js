...
(function (data) {
    ...
    , new Leg("ヘヴィガードG型", "A", "E+", "D-", "A+", "2LEG", "HG", 4, 1230, 2.6)
    ...
    , new Leg("ケーファー52", "A-", "E", "C-", "A", "2LEG", "Kafer", 4, 1230, 1.9)
    ...
    , new Leg("シュライクⅤ型", "D-", "B-", "A+", "E", "2LEG", "Shrike", 3, 770, 1.4)
    , new Leg("シュライクW型", "E", "S", "A", "E", "2LEG", "Shrike", 4, 720, 1.8)
    ...
    , new Leg("アスラ・参", "E", "C+", "S-", "E", "2LEG", "ASURA", 3, 860, 0.7)
