...
(function (data) {
    ...
    data.legs = [new Leg("クーガーⅠ型", "C+", "D+", "C-", "D", "2LEG", "Cooger", 1, 1000, 2.2)
    , new Leg("クーガーⅡ型", "C", "B-", "C-", "D", "2LEG", "Cooger", 2, 1000, 2.2)
    , new Leg("クーガーS型", "C+", "D", "B", "C", "2LEG", "Cooger", 3, 1050, 1.6)
    , new Leg("クーガーNX", "B-", "E+", "B+", "C", "2LEG", "Cooger", 4, 1120, 1.4)
    , new Leg("ツェーブラ38", "C", "B-", "D", "C-", "2LEG", "Zebra", 1, 1000, 2.6)
    , new Leg("ツェーブラ39", "C", "A-", "D", "D+", "2LEG", "Zebra", 2, 950, 2.6)
    , new Leg("ツェーブラ41", "C", "C-", "C+", "C-", "2LEG", "Zebra", 3, 1050, 2.4)
    , new Leg("ツェーブラ48C", "C+", "B", "B-", "C-", "2LEG", "Zebra", 4, 1100, 2)
    ...
    , new Leg("ネレイド45", "C", "B-", "C+", "D+", "HOVER", "Nereid", 1, 900, 2.2)
    , new Leg("ネレイド45改", "C", "C+", "C+", "C-", "HOVER", "Nereid", 2, 880, 2.1)
    , new Leg("ネレイド46", "C", "C+", "B", "D+", "HOVER", "Nereid", 3, 940, 2.2)
    ...
    , new Leg("迅牙・飛天", "C+", "D-", "C+", "B", "2LEG", "Jinga", 4, 1100, 1.5)
    ...
    , new Leg("ジーシェン", "A-", "C-", "D-", "A-", "JIXIEN", 1, 1180, 2.6)
, new Leg("ジーシェン・フー", "B", "C", "C-", "B+", "JIXIEN", 2, 1100, 1.6)
, new Leg("ジーシェン・シー", "A-", "D", "D", "A", "JIXIEN", 3, 1200, 2.1)];
