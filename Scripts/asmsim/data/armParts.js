...
, new Arm("エンフォーサーX型", "B", "B", "C", "D+", "Enfocer", 4, 840, 1.7)
...
, new Arm("迅牙・飛天", "B-", "B", "B-", "D", "Jinga", 4, 880, 1.4)
...
, new Arm("ランドバルクAT", "A-", "C", "B", "D-", "LANDBULK", 4, 1030, 1.5)
...
, new Arm("セイバーZX", "D", "B-", "C", "A", "Saber", 3, 720, 1.1)
